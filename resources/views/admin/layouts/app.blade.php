                    ...
                    <div class="scroll-sidebar">
                        ...
                        <nav class="sidebar-nav">
                            <ul id="sidebarnav">
                                ...
                                <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Blog</span></a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="{{url('blog')}}">List Blog</a></li>
                                        <li><a href="{{url('blog/create')}}">Tambah Blog</a></li>
                                    </ul>
                                </li>                                
                                <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Category</span></a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href=" {{url('kategori')}} ">List Category</a></li>
                                        <li><a href=" {{url('kategori/create')}} ">Tambah Category</a></li>
                                    </ul>
                                </li>                                                                
                            </ul>
                        </nav>
